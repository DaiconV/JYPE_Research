...
(cl:defmethod cl:initialize-instance :after ((m <Stop-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pg70-srv:<Stop-request> is deprecated: use pg70-srv:Stop-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Stop-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pg70-srv:<Stop-response> is deprecated: use pg70-srv:Stop-response instead.")))
